...
function Fotter() {
  return (
    <>
      <div className="s w-full h-screen bg-zinc-200 text-black overflow-hidden">
        <div
          className="continers p-20 flex gap-[40vh]"
          data-scroll
          data-scroll-speed="-.3"
        >
          <div className="l uppercase font-extrabold tracking-tighter text-7xl font-sans">
            <div className="flex items-center flex-col w-full h-full">
              <span>EYE- OPENING</span>
            </div>
          </div>
          <div className="l flex flex-col gap-20">
            <h1 className="uppercase font-extrabold tracking-tighter text-7xl font-sans">
              Presentation
            </h1>
            {/* Updated div with whitespace-nowrap */}
            <a href=""> S: Instagram Behance Facebook Linkedin</a>
            <a href=""> L: 202-1965 W 4th Ave</a>
            <a href=""> Vancouver, Canada 30 Chukarina St</a>
            <a href="">E: hello@ochi.design</a>
          </div>
        </div>
        <div className="ft px-20 flex justify-between items-center">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
